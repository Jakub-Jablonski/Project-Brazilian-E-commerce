...
order_payments_file = sys.argv[2]
customers_file = sys.argv[3]
states_file = sys.argv[4]
...
with open('/usr/local/spark/resources/data/html_reports/3c_report.html', 'w', encoding = 'utf8') as f:
    f.write(html_string)
